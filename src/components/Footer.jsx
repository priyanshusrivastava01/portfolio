      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 w-full items-end font-medium">
        <div className="flex flex-col gap-6">
          ...
          <p className="text-white/60 font-mono text-[9px] md:text-[10px]">
            &copy; {new Date().getFullYear()} Priyanshu Srivastava Studio | Built with React
          </p>
        </div>
        
        <div className="flex flex-col gap-1 md:items-center">
          <a href="mailto:priyanshu@gmail.com" className="underline hover:text-white transition-colors underline-offset-4 decoration-1 lowercase">priyanshu@gmail.com</a>
        </div>
